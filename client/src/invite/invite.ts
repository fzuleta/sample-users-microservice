...
import {validateEmail, isNumeric} from "./../_/common/functions";
...
export default class Home {
    ...
    activate(params, routeConfig){
        this.referralId = (params && params.referralId) ? decodeURIComponent(params.referralId) : "";
        if (this.referralId !== "") {
            this.api.call("/tokensale/referral/set/", {referralId: this.referralId});
        }
        this.nav.to("")
    }
}
